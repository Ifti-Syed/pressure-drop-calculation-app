...
#     with col5:
#         if selected_columns:
#             export_data = st.session_state.damper_table[selected_columns].copy()
...
#
#     with col6:
#         if selected_columns and not st.session_state.damper_table.empty:
#             try:
#                 export_data = st.session_state.damper_table[selected_columns].copy()
#                 export_data.insert(0, "Sr No", [str(i) for i in range(1, len(export_data) + 1)])
#
...
#     with col5:
#         if not st.session_state.damper_table.empty:
#             if st.session_state.export_columns:
...
#         available_columns = [col for col in st.session_state.damper_table.columns if col not in ['Select', 'Sr No']]
#
#         # Initialize export columns if not set
#         if not st.session_state.export_columns:
#             st.session_state.export_columns = available_columns
#
